...
class TestNavigation:
    ...
    def test_navigate_to_personal_account(self, browser, logged_in_user):
        ...
        assert "profile" in browser.current_url.lower(), \
    ...
    def test_navigate_from_profile_to_constructor_via_button(self, browser, logged_in_user):
        ...
        assert "stellarburgers.nomoreparties.site" in browser.current_url and \
               "profile" not in browser.current_url.lower(), \
